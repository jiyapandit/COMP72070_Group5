...
namespace MediNet_Hospital_Management_System
{
    class clsInsert
    {
       public string dbPath = @"Data Source=JIYA\SQLEXPRESS;Initial Catalog=dbOHMS;Integrated Security=True";
        ...
        public void InsertToDept(string name)
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                System.Windows.Forms.MessageBox.Show("Data successfully saved", "SAVE-MediNetHMS", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Information);
                con.Close();
            }
            catch (Exception ex)
            {
       ...
       
        {
            try
            {
               // string dbPath = @"Data Source=SONY\MSSQLSERVER00V1;Initial Catalog=dbOHMS;Integrated Security=True";
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Patient successfully added", "Save Data - MediNet+ HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.ToString(), "Error - MediNet+ HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        public void insertToEmployee(string empCode, string empSname, string empFname, string empOname, DateTimePicker empDOB, string empGender, string empContact, string empEmail, string empNationality, DateTimePicker empDateJoined, string empDepartment, string empDesignation, string empQualification, string empResidenceAddress, string empReferenceName, string empReferenceContact, PictureBox epmPhoto)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(ppic);
                cmd.ExecuteNonQuery();
                MessageBox.Show("Employee successfully added", "Save Data - MediNet+ HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
                con.Close();
        ...
        public void insertIntoUsers(ComboBox empCode, string Uname, string Pwd, ComboBox Levels)
        {
            try
            {
               ...
               // string dbPath = @"Data Source=SONY\MSSQLSERVER00V1;Initial Catalog=dbOHMS;Integrated Security=True";
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("User account successfully added", "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
                con.Close();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        public void insertIntoProduct(string proName, string proSupplier, string proLocation, double proPrice, int proQty , DateTimePicker proManuDate, DateTimePicker proExpiry, string proDescription)
        {
            ...
            try
            {
               ...
               cmd.Parameters.AddWithValue("@proLocation", proLocation.Trim());
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Product successfully added", "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
              ...
              try
            {
              ...
              //  string dbPath = @"Data Source=SONY\MSSQLSERVER00V1;Initial Catalog=dbOHMS;Integrated Security=True";
                ...
                SqlCommand cmd = new SqlCommand(sql, con);
                  ...
                  cmd.ExecuteNonQuery();
                  MessageBox.Show("Schedules book successfully", "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
                  con.Close();
        }
            catch(Exception ex)
              {
        ...
        //CONSULTATION
         public void insertIntoConsultation(ComboBox patID ,string DocCode, DateTimePicker consultDate, DateTimePicker consurtTime, string diagnoseDetails, string Treatment, string medication, PictureBox testImage) {
            try
            {
               ...
               // string dbPath = @"Data Source=SONY\MSSQLSERVER00V1;Initial Catalog=dbOHMS;Integrated Security=True";
                ...
                cmd.Parameters.Add(ppic);
                cmd.ExecuteNonQuery();
                MessageBox.Show("Consultation record successfully added", "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
         ...
         public void insertIntoSupplier(string supCode, string supName, string supContact, ComboBox supType, string supPersonInCharge, string supContactPersonInCharge, ComboBox supCountry, string supEmail, string supAddress, DateTimePicker supAgreementDate)
         {
             try
             {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Supplier record successfully added", "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
             ...
             {
                 MessageBox.Show(ex.Message, "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        //PATIENT WEIGHT AND HEIGHT
         public void insertIntoPatientWeight(string patID, string patName, double bmi, string pressure, double temperature, DateTimePicker measuredOnDate, DateTimePicker measuredOnTime)
         {
             ...
             try
             {
                 ...
                 cmd.ExecuteNonQuery();
                 MessageBox.Show("record successfully added", "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
             ...
             {
                 MessageBox.Show(ex.Message, "Error - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        //INSERT INTO DAILY TRANSACTION
         public void insertIntoDailyTransaction(string ReceiptNo, string patID, string PatientName, DateTimePicker TransDate, DateTimePicker TransTime, double Amts, double AmtBalance, string TransBy)
         {
             try
             {
                 ...
                 cmd.ExecuteNonQuery();
                 MessageBox.Show("Daily successfully added", "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        public void ItemsBills( string patID, string PatientName, DateTimePicker TransDate, DateTimePicker  TransTime,string Item,double Amts,string TransBy )
        {
            ...
            cmd.Parameters.AddWithValue("@TransBy", TransBy.Trim());
            cmd.ExecuteNonQuery();
            MessageBox.Show("Bill successfully taken", "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
    ...
    //INSERT INTO  TBL PATIENTBILL
        public void tblpatientBill(string patID, string patName, double Amts)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Amts", Amts);
                cmd.ExecuteNonQuery();
                MessageBox.Show("Bill record successfully taken", "Save Data - MediNet HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
